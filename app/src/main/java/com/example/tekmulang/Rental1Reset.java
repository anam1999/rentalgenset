...
public class Rental1Reset extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rental1_reset);
        ...
        cekpesan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ibu3=createOrder3(nama);
                panggil3(ibu3);
                Log.v("LoginReset","Nama:"+nama);


                int saya=punyaaku();
                String ibu=createOrder(saya);
                panggil1(ibu);
